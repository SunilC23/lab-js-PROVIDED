...
let modelName = document.getElementById("model-text").textContent;
let duration = parseInt(document.getElementById("duration-text").textContent);
...
function changeModel() {
    ...
    let modelName = modelText.textContent;
